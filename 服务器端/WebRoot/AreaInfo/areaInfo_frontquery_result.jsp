		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#areaInfoListPanel" aria-controls="areaInfoListPanel" role="tab" data-toggle="tab">所在区域列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>AreaInfo/areaInfo_frontAdd.jsp" style="display:none;">添加所在区域</a></li>
				</ul>
			  	<!-- Tab panes -->
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
				    	            		...
				    	            		for(int i=0;i<areaInfoList.size();i++) {
					    	            		...
					    	            		AreaInfo areaInfo = areaInfoList.get(i); //获取到所在区域对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;所在区域信息编辑</h4>
      </div>
