...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">二手跳蚤网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>OldLevel/frontlist">新旧程度</a></li>
                <li><a href="<%=basePath %>AreaInfo/frontlist">所在区域</a></li>
                  -->
                <li><a href="<%=basePath %>ProductClass/frontlist">商品类别</a></li>
                <li><a href="<%=basePath %>Product/frontlist">商品</a></li>
               
                <li><a href="<%=basePath %>Leaveword/frontlist">系统留言</a></li>
