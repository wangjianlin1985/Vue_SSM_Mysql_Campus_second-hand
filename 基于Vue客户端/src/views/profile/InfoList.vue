<template>
  <div class="info-list" v-if="profile">
    <div class="info-item" @click.stop="productList">
      <div class="title">
        <van-icon name="notes-o" color="red" />&nbsp;&nbsp;我发布二手物品<span class="title-r"><van-icon name="arrow" /></span>
      </div>
      <div class="content"><div class="info-box"></div></div>
    </div>

 <div class="info-item" @click.stop="leavewordAdd">
    <div class="title">
      <van-icon name="notes-o" color="red" />&nbsp;&nbsp;我要留言<span class="title-r"><van-icon name="arrow" /></span>
    </div>
    <div class="content"><div class="info-box"></div></div>
  </div>

    <div class="info-item" @click.stop="leavewordList">
      <div class="title">
        <van-icon name="notes-o" color="red" />&nbsp;&nbsp;我的留言列表<span class="title-r"><van-icon name="arrow" /></span>
      </div>
      <div class="content"><div class="info-box"></div></div>
    </div>
...
export default {
  ...
  methods: {
    productList() {
      this.$router.push('/product/userList')
    },
    leavewordAdd() {
      this.$router.push('/leaveword/add')
    },
    leavewordList(){
      this.$router.push('/leaveword/list')
    },
    noticeList(){
    ...
    modify() {
      //修改个人信息
      this.$router.replace('/userInfo/modify/self')
    },
    notOpen() {
